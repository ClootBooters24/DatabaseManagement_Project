...
<html lang="en-us">
    ...
    <body>
        Please select a major to view all jobs desiring that major:
        <form action="viewJobsMajor.php" method="post">
...
<?php
    if (isset($_POST['submit'])) 
    {
        ...
        $command = 'java -cp .:mysql-connector-java-5.1.40-bin.jar viewJobsMajor ' . $major;
